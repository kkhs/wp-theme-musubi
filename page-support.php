  ...
  <article class="article_main">
    ...
    <section id="top">
      <div class="title_area">
        <h1>Musubiのサポート</h1>
        <p class="sub">なぜシステム選定時にサポート体制が重要視されるのか?</p>
      </div>
      <div class="caption_area">
        <div class="section_inner">
          <p class="text">
            システムを変更するには大きな決断が伴います。<br>
            これまでやってきたことを変えるのは、現場にも負荷がかかります。<br>
        ...
        <div class="colum C">
          ...
          <div class="detail_area">
            ...
            <div class="detail">
              ...
              <div class="flex_area">
                <div class="box">
                  <h3>Musubi定着プログラム（Manabi）</h3>
                  <p class="text">
                    売って終わりではなく、薬局の先生方がMusubiを使いこなし、<br>
            ...
            <div class="detail">
              ...
              <div class="flex_area colum_wh support">
                ...
                <div class="box large">
                  ...
                  <p class="caption">
                    応答率 97.0%、一次解決率 84.0%  という高い水準で、疑問をスムーズに解決！<br>
                    Musubiに関するお困りごとは等は、サポートデスクへお電話ください！
                  </p>
                  <p class="sub">
                    ※1 サポートデスク対応後アンケート調査結果より　　※2 弊社サポートデスク 集計データ(2020年9月末実績) 　
                  </p>
                </div>
                <div class="box small">
                  <figure>
        ...
        <div class="colum plus">
          ...
          <div class="detail_area">
            ...
            <div class="detail">
              ...
              <div class="link_area">
                <ul>
                  <li><a href="#">Musubiユーザー50人が一堂に集結！「Musubi Meetup #01」を開催しました</a></li>
                  <li><a href="#">ここが変わった！Musubi導入前/導入後～Musubiを薬局内に浸透させるために取り組んだこと～[Musubi Meetup #01]</a></li>
                  <li><a href="#">薬局の「外」にもっと価値を届けたい～創業50年の老舗薬局で、Musubi導入後に見えた変化とは～[Musubi Meetup #01]</a></li>
                </ul>
              </div>
