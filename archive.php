...
#content.archive.post #entries>.tit:before {
  ...
  width: 1.33333em;
  height: 1.13333em;
  background-image: url(/wp/wp-content/themes/wp-theme-musubi/assets/images/icons/icon_blog.svg);
}
  </style>
  <article class="article_main">
    <section id="entries">
      <h1 class="tit">お役立ち資料</h1>
...
<li class="post">
    ...
    <img style="opacity: 0;" src="/assets/images/common/noimg.jpg" alt="">
    </a>
    <span class="desc">
