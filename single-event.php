...
<div id="content" class="<?php echo $post_type; ?> single">
  <article class="article_main">
    <section id="entry">
      ...
      <div class="post">
        <?php
          $entryform = get_field('cf_entryform');
        ...
        <div class="event_date">
          <div class="date">開催日時：<?php echo $overview['cf_date'] ?></div>
            <?php if($date_now < $date_end && get_field('cf_entry') && $has_entry){ ?>
              <?php if(get_field('cf_entryform')):?>
                <a class="btn cta dateCheck" href="#form_area">セミナーに参加する</a>
              <?php else: ?>
        ...
        <div class="post_content">
          ...
          ?>
          <?php if(get_field('cf_entry') && get_field('cf_entryform')):?>
        ...
        <!--  20200828追加  -->
        <?php
          if(get_field('cf_entry') && get_field('cf_entryform')):
        ?>
        <div class="post_content dateCheck" id="form_area">
          <div class="form_area">
            <h2>お申し込みフォーム</h2>
            <?php echo $entryform; ?>
          </div>
